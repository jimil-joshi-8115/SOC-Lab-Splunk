...
│   ├── admin_group_detection.spl
│   ├── rdp_login_detection.spl
│   ├── powershell_threat_hunt.spl
│   ├── process_creation_detection.spl
│   ├── log_clearing_detection.spl
│   ├── firewall_disabled_detection.spl
│   ├── scheduled_task_detection.spl
│   ├── malicious_service_detection.spl
│   ├── port_scan_detection.spl
│   ├── dns_analysis_detection.spl
│   ├── soc_dashboard_queries.spl
│   ├── splunk_alerts_config.spl
...
│   ├── kerberoasting_detection.spl
│   ├── scheduled_task_persistence_detection.spl
│   ├── clipboard_screen_capture_detection.spl
│   ├── c2_beaconing_detection.spl
│   └── timestomping_detection.spl
│
├── Investigation-Reports/
│   ├── brute_force_investigation.md
│   ├── new_user_investigation.md
│   ├── account_lockout_investigation.md
│   ├── admin_group_investigation.md
│   ├── rdp_login_investigation.md
│   ├── powershell_investigation_v2.md
│   ├── process_creation_investigation.md
│   ├── log_clearing_investigation.md
│   ├── firewall_disabled_investigation.md
│   ├── scheduled_task_investigation.md
│   ├── service_installed_investigation.md
│   ├── port_scan_investigation.md
│   ├── dns_analysis_investigation.md
│   ├── soc_dashboard_report.md
│   ├── splunk_alerts_report.md
│   ├── correlation_rules_investigation.md
...
│   ├── kerberoasting_IR-2026-012.md
│   ├── scheduled_task_persistence_IR-2026-013.md
│   ├── clipboard_screen_capture_IR-2026-014.md
│   ├── c2_beaconing_IR-2026-015.md
│   └── timestomping_IR-2026-016.md
│
├── Incident-Reports/
...
│   ├── IR-2026-012_Kerberoasting.docx
│   ├── IR-2026-013_Scheduled_Task_Persistence.docx
│   ├── IR-2026-014_Clipboard_Screen_Capture.docx
│   ├── IR-2026-015_C2_Beaconing.docx
│   └── IR-2026-016_Timestomping.docx
│
├── Scenarios/
...
│   │   └── README.md
│   ├── Scenario_11_Kerberoasting/
│   │   └── README.md
│   ├── Scenario_12_Scheduled_Task_Persistence/
│   │   └── README.md
│   ├── Scenario_13_Clipboard_Screen_Capture/
│   │   └── README.md
│   ├── Scenario_14_C2_Beaconing/
│   │   └── README.md
│   └── Scenario_15_Timestomping/
│       └── README.md
│
├── Dashboards/
│   ├── soc_security_dashboard.xml
│   ├── scenarios_overview_dashboard.xml
│   ├── labs_overview_dashboard.xml
│   ├── capstone_dashboard.xml
│   └── image dashboard/
│       ├── localhost_8000_en-GB_app_search_all_scenarios_.png
│       ├── scenarios_dashboard_panel_01.png
│       ├── scenarios_dashboard_panel_02.png
│       ├── scenarios_dashboard_panel_03.png
│       ├── labs_dashboard_01_overview.png
│       ├── labs_dashboard_02_brute_force_admin.png
│       ├── labs_dashboard_03_powershell_service_log.png
│       ├── labs_dashboard_04_process_creation.png
│       ├── labs_dashboard_05_recent_activity.png
│       ├── capstone_dashboard_full.png
│       ├── capstone_dashboard_01_summary_panels.png
│       ├── capstone_dashboard_02_mitre_timeline.png
│       ├── capstone_dashboard_03_labs_accounts.png
│       ├── capstone_dashboard_04_scenarios_severity.png
│       ├── capstone_dashboard_05_correlation_rules.png
│       ├── capstone_dashboard_06_high_risk_commands.png
│       ├── capstone_dashboard_07_network_dns.png
│       └── capstone_dashboard_08_recent_events.png
│
└── screenshots/
    └── (100+ evidence screenshots — Splunk query results, raw events,
         stats tables, and dashboard captures across all 16 labs and
         15 scenarios)
```
...
### Extended Scenarios (Beyond Original 10-Scenario Campaign)

| # | Scenario | MITRE ATT&CK | Severity | Status |
|---|---|---|---|---|
| 11 | Kerberoasting | T1558.003 | 🔴 Critical | ✅ Completed |
| 12 | Scheduled Task Persistence (Remote-Trigger) | T1053.005 | 🟠 High | ✅ Completed |
| 13 | Clipboard & Screen Capture Collection | T1115 / T1113 | 🟠 High | ✅ Completed |
| 14 | Command & Control — DNS/HTTP Beaconing | T1071.004 / T1071.001 | 🔴 Critical | ✅ Completed |
| 15 | Indicator Removal — Timestomping | T1070.006 | 🟠 High | ✅ Completed |
...
T1136, T1098, T1070.001, T1486, T1490, T1021, T1021.002, T1047, T1560, T1048, T1071.004, T1071.001, T1566.001, T1204.002, T1105, T1218.005, T1218.011, T1218.010, T1547.001, T1562.001, T1003.001, T1110.003, T1558.003, T1053.005, T1115, T1113, T1070.006
...
### Story
> An attacker with a foothold in an Active Directory environment requests Kerberos service tickets for SPN-registered service accounts, then takes the ticket offline to crack the service account's password hash — all without triggering a lockout, since requesting a service ticket is normal Kerberos behavior. Since this lab is a standalone host without AD, the command-line signatures of real Kerberoasting tools are simulated safely without an actual domain or ticket.

### Attack Chain
```
SPN enumeration via setspn.exe (4688) → Rubeus-style ticket extraction reference (4688) → Native PowerShell Kerberos ticket request (4688)
```

### Real SOC Lesson — Command-Wrapping Strikes Again
For the second time in this campaign (first seen in Scenario 09), all three simulated commands logged as `cmd.exe` rather than the referenced tool name, since each was wrapped in `echo`. This reinforces, across two separate scenarios now, that detection logic relying on process name alone will miss these patterns — full command-line content filtering is essential.

### Verdict
**✅ TRUE POSITIVE — Simulated Kerberoasting Attempt Confirmed**

📄 [Investigation Report](Investigation-Reports/kerberoasting_IR-2026-012.md) | 📄 [Scenario Details](Scenarios/Scenario_11_Kerberoasting/README.md) | 📄 [Incident Report](Incident-Reports/IR-2026-012_Kerberoasting.docx)

![Kerberoasting Combined Chain](screenshots/kerberoasting_combined_chain.png)
...
### Story
> Building on Lab 10, an attacker creates a scheduled task disguised under a name closely mimicking a legitimate Windows component (`MicrosoftEdgeUpdateTaskMachine`), configured to trigger at every logon and run a payload staged in the Temp directory — designed to survive reboots while blending in with routine update automation.

### Attack Chain
```
Task created — disguised name, onlogon trigger, Temp payload (4688) → Verification query (4688) → Manual execution (4688) → Cleanup/delete (4688)
```

### Real SOC Lesson — Beyond Binary-Name Matching
Filtering on `schtasks.exe` alone would be far too noisy for production use, since it's used constantly for legitimate IT automation. A meaningfully stronger detection rule combines the `onlogon` trigger type with a `Temp`-directory target path — a combination rarely seen in legitimate task configurations. The near-miss task name (`MicrosoftEdgeUpdateTaskMachine` vs. the real `MicrosoftEdgeUpdateTaskMachineCore`) also reinforces the naming-disguise lesson first introduced in Scenario 07.

### Verdict
**✅ TRUE POSITIVE — Simulated Scheduled Task Persistence Confirmed**

📄 [Investigation Report](Investigation-Reports/scheduled_task_persistence_IR-2026-013.md) | 📄 [Scenario Details](Scenarios/Scenario_12_Scheduled_Task_Persistence/README.md) | 📄 [Incident Report](Incident-Reports/IR-2026-013_Scheduled_Task_Persistence.docx)

![Scheduled Task Persistence Lifecycle](screenshots/scheduled_task_persistence_lifecycle.png)
...
### Story
> Before exfiltrating data (Scenario 04), an attacker first needs to collect it. This scenario simulates two quiet, low-effort collection techniques: clipboard monitoring (catching anything a user copies) and periodic screen capture (capturing on-screen content even if it was never saved to disk).

### Attack Chain
```
Clipboard contents captured to file (4688) → First screen capture saved (4688) → Second screen capture ~9s later (4688)
```

### Real SOC Lesson — Aggregation Beats Keyword Matching
A single screenshot event could plausibly be ordinary user activity (e.g., a manual PrintScreen). The stronger detection signal came from **counting repeated captures per account within a time window** — 2 captures, ~9 seconds apart, confirmed via aggregation (`stats count ... where capture_count >= 2`) rather than simple keyword matching alone. This aggregation-based approach generalizes well to other "low-and-slow" collection or reconnaissance techniques.

### Verdict
**✅ TRUE POSITIVE — Simulated Clipboard & Screen Capture Collection Confirmed**

📄 [Investigation Report](Investigation-Reports/clipboard_screen_capture_IR-2026-014.md) | 📄 [Scenario Details](Scenarios/Scenario_13_Clipboard_Screen_Capture/README.md) | 📄 [Incident Report](Incident-Reports/IR-2026-014_Clipboard_Screen_Capture.docx)

![Collection Combined Chain](screenshots/collection_combined_chain.png)
...
### Story
> Unlike Scenario 04's burst-style DNS tunneling, an established malware implant instead checks in periodically with its C2 server — low-volume, but the *regularity* of the interval is the giveaway. Simulated using regular-interval `nslookup` and `Invoke-WebRequest` calls to a safe domain.

### Attack Chain
```
DNS beacon check-in #1 (4688) → DNS beacon check-in #2, ~4.7s later (4688) → DNS beacon check-in #3, ~21.3s later (4688) → HTTP beacon check-in, ~31.2s later (4688)
```

### Real SOC Lesson — Honest Limitation of Manual Simulation
Real beaconing detection hinges on **low jitter/variance** between check-in intervals, not just repetition — true C2 beacons vary by only a few percent around a fixed interval. The manually-triggered check-ins here were *not* perfectly regular (gaps of ~4.7s, ~21.3s, ~31.2s), since a human pressing Enter can't replicate a timer-driven implant. This is documented transparently as a simulation limitation: the detection queries and analytical approach (calculating inter-arrival deltas) are correct and production-relevant, even though this particular dataset doesn't itself exhibit true low-jitter regularity.

### Verdict
**✅ TRUE POSITIVE — Simulated C2 Beaconing Pattern Confirmed (Detection Methodology Validated)**

📄 [Investigation Report](Investigation-Reports/c2_beaconing_IR-2026-015.md) | 📄 [Scenario Details](Scenarios/Scenario_14_C2_Beaconing/README.md) | 📄 [Incident Report](Incident-Reports/IR-2026-015_C2_Beaconing.docx)

![C2 Beaconing Combined Chain](screenshots/c2_beaconing_combined_chain.png)
...
### Story
> The final scenario in this campaign's extended set — and fittingly, an anti-forensics technique. After finishing their activity, an attacker manipulates a file's timestamp metadata (creation, modified, accessed) to disguise its true age and disrupt forensic timeline reconstruction.

### Attack Chain
```
Baseline timestamp check (4688) → Timestomp executed — all 3 timestamps set to 2020-01-15 (4688) → Verification check x2 (4688)
```

### Real SOC Lesson — Closing the Anti-Forensics Thread
The highest-confidence indicator isn't any single timestamp field — it's that `CreationTime`, `LastWriteTime`, and `LastAccessTime` were all set to one identical, hardcoded historical value in a single command, a pattern essentially never seen in normal file activity. This scenario also closes a recurring theme spanning the entire campaign: Lab 08 (log clearing) → Scenario 02 (shadow copy deletion) → this scenario (timestamp manipulation) — three different mechanisms serving the same underlying attacker goal of hiding evidence.

### Verdict
**✅ TRUE POSITIVE — Simulated Timestomping Confirmed**

📄 [Investigation Report](Investigation-Reports/timestomping_IR-2026-016.md) | 📄 [Scenario Details](Scenarios/Scenario_15_Timestomping/README.md) | 📄 [Incident Report](Incident-Reports/IR-2026-016_Timestomping.docx)

![Timestomping Combined Lifecycle](screenshots/timestomping_combined_lifecycle.png)

---

> 🏁 **Extended Scenario Set (11–15) — Complete.** Combined with the original 10-scenario campaign, this repository now spans 16 foundational labs and 15 full investigative scenarios, covering the full MITRE ATT&CK lifecycle from Initial Access through Defense Evasion, Credential Access, Collection, and Command & Control. Next: a unified dashboard across all labs and scenarios, followed by a dedicated noise/triage practice repository — see [Coming Next](#-coming-next).
...
- Kerberoasting detection (Active Directory credential access) & command-wrapping evasion awareness
- Advanced scheduled task persistence detection & production-grade detection rule tuning
- Data collection technique detection (clipboard, screen capture) & aggregation-based detection logic
- C2 beaconing detection methodology (DNS/HTTP) & interval-regularity/jitter analysis
- Anti-forensics detection (timestomping) & cross-campaign pattern recognition
...
|---|---|---|
| SOC Security Dashboard | [`Dashboards/soc_security_dashboard.xml`](Dashboards/soc_security_dashboard.xml) | Original Lab 14 dashboard — key security event metrics across the 16 foundational labs |
| 15-Scenario Campaign Overview | [`Dashboards/scenarios_overview_dashboard.xml`](Dashboards/scenarios_overview_dashboard.xml) | Unified dashboard across all 15 simulated attack scenarios — MITRE tactic breakdown, activity timeline, severity reference, and top-suspicious-commands (noise-tuned per Scenario 06) |
| 16 Labs Overview | [`Dashboards/labs_overview_dashboard.xml`](Dashboards/labs_overview_dashboard.xml) | Focused dashboard covering all 16 foundational labs — event counts by lab, high-signal event distribution, PowerShell threats, malicious services, log clearing, and drill-down tables |
| SOC L1 Capstone — 16 Labs + 15 Scenarios | [`Dashboards/capstone_dashboard.xml`](Dashboards/capstone_dashboard.xml) | Full capstone dashboard spanning everything — 12 summary panels, MITRE tactic coverage bar chart, lab vs scenario timeline, 16-lab event breakdown, 15-scenario event breakdown, severity reference, 3 correlation rules, high-risk command feed, port scan, DNS analysis, suspicious DNS queries, and recent events table |

Dashboard screenshots: [`Dashboards/image dashboard/`](Dashboards/image%20dashboard/)

### Scenarios Dashboard Screenshots
| Screenshot | Description |
|---|---|
| `localhost_8000_en-GB_app_search_all_scenarios_.png` | Full-page scenarios dashboard view |
| `scenarios_dashboard_panel_01.png` | Overview stats + severity reference |
| `scenarios_dashboard_panel_02.png` | Events by scenario + MITRE tactic breakdown |
| `scenarios_dashboard_panel_03.png` | Top suspicious commands + recent activity |

### Labs Dashboard Screenshots
| Screenshot | Description |
|---|---|
| `labs_dashboard_01_overview.png` | Top summary panels + event type pie + timeline |
| `labs_dashboard_02_brute_force_admin.png` | Brute force failed logons + admin group changes |
| `labs_dashboard_03_powershell_service_log.png` | PowerShell threats + malicious services + log clearing |
| `labs_dashboard_04_process_creation.png` | Suspicious process creation (Lab 07) |
| `labs_dashboard_05_recent_activity.png` | Recent high-signal lab activity table |

### Capstone Dashboard Screenshots
| Screenshot | Description |
|---|---|
| `capstone_dashboard_full.png` | Full-page capstone dashboard — all panels |
| `capstone_dashboard_01_summary_panels.png` | 12 summary single-value panels (labs + scenarios) |
| `capstone_dashboard_02_mitre_timeline.png` | MITRE ATT&CK tactic bar chart + lab vs scenario timeline |
| `capstone_dashboard_03_labs_accounts.png` | 16-lab event count table + top accounts bar chart |
| `capstone_dashboard_04_scenarios_severity.png` | 15-scenario event count table + severity score chart |
| `capstone_dashboard_05_correlation_rules.png` | 3 correlation rules (brute force success, backdoor admin, attack + evidence destroyed) |
| `capstone_dashboard_06_high_risk_commands.png` | High-risk commands from your scenario simulations |
| `capstone_dashboard_07_network_dns.png` | Port scan top ports + DNS top domains + suspicious DNS queries |
| `capstone_dashboard_08_recent_events.png` | Recent security events — all labs + scenarios (last 30) |
...
This repository is now **complete** — 16 labs, 15 scenarios, and 4 Splunk dashboards. All content is mapped to MITRE ATT&CK and documented with professional incident reports.

**✅ Completed in this repo:**
- 16 Foundational Detection Labs
- 15 Simulated Attack Scenarios (Scenarios 01–15)
- SOC Security Dashboard (original)
- 15-Scenario Campaign Overview Dashboard
- 16-Labs Overview Dashboard
- SOC L1 Capstone Dashboard (16 Labs + 15 Scenarios combined)

**Next project:** a dedicated **SOC Noise & Triage Practice Repository** — generating realistic background activity alongside injected malicious events, and practicing true-positive vs. false-positive triage and documentation under noisy, ambiguous conditions (rather than the clean, isolated scenarios used throughout this repo). This more closely mirrors real SOC L1 queue triage work.
