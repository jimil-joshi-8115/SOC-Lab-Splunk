...
### What I Did
- Created 5 automated Splunk alerts covering critical attack scenarios
- Configured scheduled and real-time alerts
- Triggered Brute Force alert 6 times by simulating failed logins
- Demonstrated complete automated SOC alerting system

### Alerts Created

| Alert | Event ID | Severity | Type |
|---|---|---|---|
| Brute Force Detection | 4625 | 🟠 High | Scheduled |
| Log Clearing — Critical | 1102 | 🔴 Critical | Scheduled |
| New User Created | 4720 | 🟠 High | Scheduled |
| Privilege Escalation | 4732 | 🔴 Critical | Scheduled |
| Malicious Service Installed | 7045 | 🔴 Critical | Scheduled |

### Result
All 5 alerts configured and enabled. Brute Force alert triggered **6 times** confirming automated detection is working!
