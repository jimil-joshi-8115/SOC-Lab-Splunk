...
# 🚨 PART 2 — Advanced Threat Scenarios

> Real-world attack simulations combining multiple techniques — going beyond single event detection to full attack chain investigation.

| # | Scenario | Key Techniques | MITRE | Severity | Status |
|---|---|---|---|---|---|
| 1 | Insider Threat Detection | Account creation, Privilege escalation, Log clearing | T1136, T1098, T1070.001 | Critical | ✅ Completed |
| 2 | Ransomware Simulation | File + Process analysis | T1486, T1059 | Critical | 🔜 Coming Soon |
| 3 | Lateral Movement Detection | Network + Auth logs | T1021, T1550 | Critical | 🔜 Coming Soon |
| 4 | Data Exfiltration Detection | DNS + Network logs | T1048, T1071.004 | High | 🔜 Coming Soon |
| 5 | Phishing Attack Detection | Email + Process logs | T1566, T1059 | High | 🔜 Coming Soon |

---

## 🚨 Scenario 1 — Insider Threat Detection

> **Story:** An employee suspected of stealing data before leaving. Detected complete insider threat attack chain using Splunk correlation.

### What Was Detected
- ✅ Backdoor user account created
- ✅ Account added to Administrators group
- ✅ Security logs cleared to destroy evidence
...
```
Step 1: Account 'hp' created user 'insider'    → Event ID 4720 ✅ DETECTED
Step 2: Account 'hp' added 'insider' to Admins → Event ID 4732 ✅ DETECTED
Step 3: Account 'hp' cleared Security logs     → Event ID 1102 ✅ DETECTED
...
### Report ID: IR-2026-002 — Severity: CRITICAL
