...
### What I Did
- Enabled Windows DNS Client Operational logging
- Added DNS log source to Splunk
- Simulated normal and suspicious DNS queries using nslookup
- Used SPL regex to extract domain names from DNS logs
- Detected suspicious domain `suspicious-domain.xyz` — C2 communication pattern
...
| Domain | Count | Risk |
|---|---|---|
| watson.events.data.microsoft.com | 200 | ✅ Normal |
| dns.msftncsi.com | 84 | ✅ Normal |
| google.com | 20 | ✅ Normal |
| **suspicious-domain.xyz** | 1 | 🔴 **Suspicious!** |

### Result
Splunk detected **853 DNS events** including suspicious query for `suspicious-domain.xyz` — consistent with C2 communication pattern.
