...
│   └── image dashboard/
│       ├── localhost_8000_en-GB_app_search_all_scenarios_.png   (full-page view)
│       ├── scenarios_dashboard_panel_01.png                     (panel detail 1)
│       ├── scenarios_dashboard_panel_02.png                     (panel detail 2)
│       └── scenarios_dashboard_panel_03.png                     (panel detail 3)
│
└── screenshots/
...
| 15-Scenario Campaign Overview | [`Dashboards/scenarios_overview_dashboard.xml`](Dashboards/scenarios_overview_dashboard.xml) | Unified dashboard across all 15 simulated attack scenarios — total events, MITRE tactic breakdown, activity timeline, severity reference, and a top-suspicious-commands table tuned to exclude confirmed-legitimate `rundll32.exe` background noise (per Scenario 06 findings) |

Dashboard screenshots: [`Dashboards/image dashboard/`](Dashboards/image%20dashboard/)

| Screenshot | Description |
|---|---|
| `localhost_8000_en-GB_app_search_all_scenarios_.png` | Full-page view — all panels (overview stats, severity reference, events by scenario, MITRE tactic pie, activity timeline, top commands, recent activity) |
| `scenarios_dashboard_panel_01.png` | Panel detail — overview stats + severity reference |
| `scenarios_dashboard_panel_02.png` | Panel detail — events by scenario / MITRE tactic breakdown |
| `scenarios_dashboard_panel_03.png` | Panel detail — top suspicious commands / recent activity tables |
...
All 15 simulated attack scenarios are complete, and the unified scenarios dashboard is now live. Next steps:

- [x] ~~Unified Scenarios Dashboard~~ — ✅ Complete: [`Dashboards/scenarios_overview_dashboard.xml`](Dashboards/scenarios_overview_dashboard.xml)
- [ ] **Combined Labs + Scenarios Capstone Dashboard** — a single rollup dashboard spanning all 16 labs and all 15 scenarios, serving as the top-level summary view for the entire repository
...
**Beyond this repo:** a dedicated **noise/triage practice repository** — generating realistic background activity alongside injected malicious events, and practicing true-positive vs. false-positive triage and documentation under noisy, ambiguous conditions (rather than the clean, isolated scenarios used throughout this repo). This more closely mirrors real SOC queue triage, and will be built as its own separate, focused project.
